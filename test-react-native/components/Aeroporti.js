...
const Aeroporti = () => {
  ...
  useEffect(() => {
    const fetchDati = async () => {
      try {
        const response = await axios.get('http://172.20.0.1:5002/api/aeroporti');
  ...
  return (
    <ScrollView contentContainerStyle={styles.scrollContainer}>
      <View style={styles.tableRowHeader}>
        <Text style={styles.tableHeaderCell}>Codice Aeroporto</Text>
        <Text style={styles.tableHeaderCell}>Nome Aeroporto</Text>
        <Text style={styles.tableHeaderCell}>Città</Text>
        <Text style={styles.tableHeaderCell}>Nazione</Text>
      </View>
